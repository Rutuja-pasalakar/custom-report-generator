...
const text =
  "Reliance Industries Limited (RIL) is an Indian multinational conglomerate company headquartered in Mumbai, India. RIL's diverse businesses include energy, petrochemicals, natural gas, retail, telecommunications, mass media, and textiles. The company has shown consistent growth across all segments with strong fundamentals and market leadership position.";
